...
class StateChange:
	...
	# Suitable for tracking properties of persistent objects, like projects.
	...
	# Suitable for tracking nested or complex properties of persistent objects, like element rectangles.
	# When change accumulation is enabled, finds the original item and redefines its do action.
	...
	# Suitable for tracking properties of indexed members of persistent objects, like canvases or elements.
	# When change accumulation is enabled, finds the original item and redefines its do action.
