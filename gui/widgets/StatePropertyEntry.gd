...
func _update_theme() -> void:
	...
	var buttons: Array[Button] = [ _rename_state_button, _delete_state_button ]
	for button in buttons:
		...
		button.add_theme_color_override("icon_normal_color", get_theme_color("button_icon_normal"))
		button.add_theme_color_override("icon_hover_color", get_theme_color("button_icon_hover"))
		button.add_theme_color_override("icon_pressed_color", get_theme_color("button_icon_pressed"))
...
func _clear_theme() -> void:
	...
	for button in buttons:
		...
		button.remove_theme_color_override("icon_hover_color")
		button.remove_theme_color_override("icon_pressed_color")
		button.end_bulk_theme_override()
